...
public class MailUtil {
	private static String myEmailAccount = "2786850898@qq.com";
	// 修改为自己的邮箱授权码
	private static String myEmailPassword = "dgdpuxrfbpvrdcgc";
	// 如果用qq邮箱不用修改，如果用163邮箱，修改为smtp.163.com
	private static String myEmailSMTPHost = "smtp.qq.com";
	private static String sendUser = "3348325239@qq.com";
